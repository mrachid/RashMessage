...
class ViewController: MessageViewController, MessageDelegate {
    func sendMessage() {
    ...
    let messages = [
        ...
        [
            ChatMessage(id: 7, text: "Voici le premier message ecrit dans la 4eme section", from: nil, avatar: nil, createdAt: Date.dateFromCustomString(customString: "15/08/2018"), isIncomming: false),
            ChatMessage(id: 8, text: "Bienvenue à l'équipe de charlatan", from: nil, avatar: nil, createdAt: Date.dateFromCustomString(customString: "15/08/2018"), isIncomming: false),
            ChatMessage(id: 9, text: "Je vous souhaite d'heureuse fete et plein de bonne chose et oui j'écrit des choses qui on un sens pour des test mouahahhaa!!!!!!", from: nil, avatar: nil, createdAt: Date.dateFromCustomString(customString: "15/08/2018"), isIncomming: false),
            ChatMessage(id: 10, text: "Mouaiiis....!", from: nil, avatar: nil, createdAt: Date.dateFromCustomString(customString: "15/08/2018"), isIncomming: true)
        ]
    ]
